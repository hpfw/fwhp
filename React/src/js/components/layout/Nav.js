            ...
            <nav class="navbar navbar-default navbar-fixed-top schrift">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <IndexLink to="/" class="navbar-brand mouse_curser" onClick={() => this.handleClick("home")}>Freiwillige
                            Feuerwehr Waldburg</IndexLink>
                    </div>
                    <div class="collapse navbar-collapse" id="myNavbar">
                        <ul class="nav navbar-nav navbar-right">
                            <li class={this.state.home == true ? 'mouse_curser active' : 'mouse_curser'}
                                onClick={() => this.handleClick("home")}><IndexLink to="/">HOME</IndexLink ></li>
                            <li class={this.state.aktuelles == true ? 'mouse_curser active' : 'mouse_curser'}
                                onClick={() => this.handleClick("aktuelles")}><IndexLink to="/">AKTUELLES</IndexLink >
                            </li>
                            <li class={this.state.termine == true ? 'mouse_curser active' : 'mouse_curser'}
                                onClick={() => this.handleClick("termine")}><IndexLink to="/">TERMINE</IndexLink ></li>
                            <li class={this.state.contact == true ? 'mouse_curser active' : 'mouse_curser'}
                                onClick={() => this.handleClick("contact")}><IndexLink to="/">KONTAKT</IndexLink ></li>
